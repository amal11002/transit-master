          ...
          <div className="content-side">
            <ul className="nav-main">
              ...
              {userRole.includes('Chef departement') && (
                <li className="nav-main-item">
                  <a className="nav-main-link" href="#!" onClick={() => navigateTo('/chef3')}>
              ...
              {(userRole.includes('Assistant departement') || userRole.includes('Chef departement')) && (
                <li className="nav-main-item">
                  <a className="nav-main-link" href="#!" onClick={() => navigateTo('/assistant3')}>
                    <i className="nav-main-link-icon si si-energy"></i>
                    <span className="nav-main-link-name">Assistant département</span>
                  </a>
                </li>
              )}
              {(userRole.includes('Comptable') || userRole.includes('Chef departement')) && (
                <li className="nav-main-item">
                  <a className="nav-main-link" href="#!" onClick={() => navigateTo('/comptable')}>
                    <i className="nav-main-link-icon si si-energy"></i>
